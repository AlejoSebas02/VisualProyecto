...
(function ($) {
    ...
    $.fn.timeline.defaults = {
        width: "auto", height: "auto", align: "left", data: [], dotStyler: function (row) {
            return "";
...
(function ($) {
    ...
    function _33f(_340, pp, _341) {
        ...
        pp.panel($.extend({}, { collapsible: true, minimizable: false, maximizable: false, closable: false, doSize: false, collapsed: true, headerCls: "accordion-header", bodyCls: "accordion-body", halign: opts.halign }, _341, {
            onBeforeExpand: function () {
    ...
    $.fn.accordion.defaults = {
        width: "auto", height: "auto", fit: false, border: true, animate: true, multiple: false, selected: 0, halign: "top", onSelect: function (_36d, _36e) {
...
(function ($) {
    ...
    function _3a7(_3a8, _3a9, pp) {
        ...
        pp.panel($.extend({}, _3a9, {
            tab: tab, border: false, noheader: true, closed: true, doSize: false, iconCls: (_3a9.icon ? _3a9.icon : undefined), onLoad: function () {
                if (_3a9.onLoad) {
    ...
    $.fn.tabs.defaults = {
        width: "auto", height: "auto", headerWidth: 150, tabWidth: "auto", tabHeight: 32, selected: 0, showHeader: true, plain: false, fit: false, border: true, justified: false, narrow: false, pill: false, tools: null, toolPosition: "right", tabPosition: "top", scrollIncrement: 100, scrollDuration: 400, onLoad: function (_3f4) {
...
(function ($) {
    ...
    function _413(_414, _415, el) {
        ...
        var _417 = $.extend({}, $.fn.layout.paneldefaults, {
        ...
        _41b.resizable($.extend({}, {
            handles: (_41a[dir] || ""), disabled: (!pp.panel("options").split), onStartResize: function (e) {
                _403 = true;
    ...
    function _430(_431, _432, _433) {
        ...
        function _438(dir) {
            ...
            p.panel($.extend({}, $.fn.layout.paneldefaults, {
                cls: ("layout-expand layout-expand-" + dir), title: "&nbsp;", titleDirection: _436.titleDirection, iconCls: (_436.hideCollapsedContent ? null : _436.iconCls), closed: true, minWidth: 0, minHeight: 0, doSize: false, region: _436.region, collapsedSize: _436.collapsedSize, noheader: (!isns && _436.hideExpandTool), tools: ((isns && _436.hideExpandTool) ? null : [{
    ...
    $.fn.layout.defaults = {
        fit: false, onExpand: function (_466) {
    ...
    $.fn.layout.paneldefaults = $.extend({}, $.fn.panel.defaults, {
        region: null, split: false, collapseDelay: 100, collapsedSize: 32, expandMode: "float", hideExpandTool: false, hideCollapsedContent: true, collapsedContent: function (_46b) {
            var p = $(this);
...
(function ($) {
    ...
    $.fn.menu.defaults = {
        zIndex: 110000, left: 0, top: 0, alignTo: null, align: "left", minWidth: 150, itemHeight: 32, duration: 100, hideOnUnhover: true, inline: false, fit: false, noline: false, events: { mouseenter: _486, mouseleave: _489, mouseover: _48d, mouseout: _490, click: _492 }, position: function (_4cd, left, top) {
            return { left: left, top: top };
        }, onShow: function () {
        }, onHide: function () {
...
(function ($) {
    ...
    function _4d7(_4d8, _4d9, data) {
        ...
        $(_4d9).tooltip({
            content: $("<div></div>"), position: opts.floatMenuPosition, valign: "top", data: data, onUpdate: function (_4da) {
...
(function ($) {
    ...
    $.fn.switchbutton.defaults = {
        handleWidth: "auto", width: 60, height: 30, checked: false, disabled: false, readonly: false, reversed: false, onText: "ON", offText: "OFF", handleText: "", value: "on", label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_543) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiobutton.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_569) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkbox.defaults = {
        width: 20, height: 20, value: null, disabled: false, readonly: false, checked: false, label: null, labelWidth: "auto", labelPosition: "before", labelAlign: "left", onChange: function (_58f) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.radiogroup.defaults = {
        dir: "h", name: null, value: null, labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_59f) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.checkgroup.defaults = {
        dir: "h", name: null, value: [], labelWidth: "", labelPosition: "after", labelAlign: "left", itemStyle: { height: 30 }, onChange: function (_5b3) {
        }
    };
})(jQuery);
(function ($) {
    ...
    $.fn.validatebox.defaults = {
        required: false, validType: null, validParams: null, delay: 200, interval: 200, missingMessage: "This field is required.", invalidMessage: null, tipPosition: "right", deltaX: 0, deltaY: 0, novalidate: false, editable: true, disabled: false, readonly: false, validateOnCreate: true, validateOnBlur: false, events: {
            focus: _5bb, blur: _5bf, mouseenter: _5c2, mouseleave: _5c5, click: function (e) {
                var t = $(e.data.target);
...
(function ($) {
    ...
    function _5f9(_615) {
        ...
        _616.validatebox($.extend({}, opts, {
            deltaX: function (_617) {
...
(function ($) {
    ...
    $.fn.passwordbox.defaults = $.extend({}, $.fn.textbox.defaults, {
        passwordChar: "%u25CF", checkInterval: 200, lastDelay: 500, revealed: false, showEye: true, inputEvents: {
            focus: _662, blur: _666, keydown: function (e) {
...
(function ($) {
    ...
    function load(_6d2, data) {
        ...
        if (typeof data == "string") {
            ...
            $.ajax({
                url: data, data: _6d3, dataType: "json", success: function (data) {
                    _6d4(data);
                }, error: function () {
...
(function ($) {
    function _73e(_73f) {
        ...
        $(_73f).addClass("spinner-f").textbox($.extend({}, opts, {
            icons: _741, doSize: false, onResize: function (_743, _744) {
                if (!opts.spinArrow) {
                    var span = $(this).next();
...
(function ($) {
    ...
    $.fn.rate.defaults = {
        value: 0, max: 5, size: 24, half: false, readonly: false, disabled: false, starSvg: "<svg focusable=\"false\" viewBox=\"0 0 24 24\"><path d=\"M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z\"></path></svg>", color: "#ececec", selectedColor: "#ffca3e", onChange: function (_7a4, _7a5) {
        }
    };
})(jQuery);
(function ($) {
    ...
    function _7ef(_7f0) {
        ...
        _7f2.panel($.extend({}, opts, {
            id: null, doSize: false, onResize: function (_7f3, _7f4) {
        ...
        if (opts.pagination) {
            ...
            _7f8.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_7f9, _7fa) {
    ...
    function _809(_80a) {
        ...
        _80f.each(function () {
            $(this).resizable({
                handles: _810, edge: opts.resizeEdge, disabled: ($(this).attr("resizable") ? $(this).attr("resizable") == "false" : false), minWidth: 25, onStartResize: function (e) {
                    _80b.resizing = true;
    ...
    var _952 = $.extend({}, _944(["text", "textbox", "passwordbox", "filebox", "numberbox", "numberspinner", "combobox", "combotree", "combogrid", "combotreegrid", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
            init: function (_953, _954) {
    ...
    $.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
        sharedStyleSheet: false, frozenColumns: undefined, columns: undefined, fitColumns: false, resizeHandle: "right", resizeEdge: 5, autoRowHeight: true, toolbar: null, striped: false, method: "post", nowrap: true, idField: null, url: null, data: null, loadMsg: "Processing, please wait ...", emptyMsg: "", rownumbers: false, singleSelect: false, ctrlSelect: false, selectOnCheck: true, checkOnSelect: true, pagination: false, pagePosition: "bottom", pageNumber: 1, pageSize: 10, pageList: [10, 20, 30, 40, 50], queryParams: {}, sortName: null, sortOrder: "asc", multiSort: false, remoteSort: true, showHeader: true, showFooter: false, scrollOnSelect: true, scrollbarSize: 18, rownumberWidth: 30, editorHeight: 31, headerEvents: { mouseover: _813(true), mouseout: _813(false), click: _817, dblclick: _81c, contextmenu: _81f }, rowEvents: { mouseover: _821(true), mouseout: _821(false), click: _828, dblclick: _832, contextmenu: _836 }, rowStyler: function (_9e2, _9e3) {
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _9e4, dataType: "json", success: function (data) {
                    _9e5(data);
                }, error: function () {
            ...
            getTr: function (_9e7, _9e8, type, _9e9) {
                type = type || "body";
                _9e9 = _9e9 || 0;
...
(function ($) {
    ...
    function _a1e(_a1f) {
        ...
        $(_a1f).datagrid($.extend({}, opts, {
            cls: "propertygrid", view: (opts.showGroup ? opts.groupView : opts.view), onBeforeEdit: function (_a21, row) {
    ...
    var _a2d = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_a2e, _a2f, _a30) {
            var _a31 = [];
    ...
    $.extend(_a2d, {
        refreshGroupTitle: function (_a63, _a64) {
...
(function ($) {
    function _a84(_a85) {
        ...
        if (opts.pagination) {
            ...
            _a91.pagination({
                total: 0, pageNumber: opts.pageNumber, pageSize: opts.pageSize, pageList: opts.pageList, onSelectPage: function (_a92, _a93) {
    ...
    var _b31 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b32, _b33, _b34) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, checkbox: false, cascadeCheck: true, onlyLeafCheck: false, lines: false, animate: false, singleSelect: true, view: _b31, rowEvents: $.extend({}, $.fn.datagrid.defaults.rowEvents, { mouseover: _a9f(true), mouseout: _a9f(false), click: _aa1 }), loader: function (_b6f, _b70, _b71) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
            ...
            getTr: function (_b73, id, type, _b74) {
                type = type || "body";
                _b74 = _b74 || 0;
...
(function ($) {
    function _b7d(_b7e) {
        ...
        $(_b7e).datagrid($.extend({}, opts, {
            cls: "datalist" + (opts.lines ? " datalist-lines" : ""), frozenColumns: (opts.frozenColumns && opts.frozenColumns.length) ? opts.frozenColumns : (opts.checkbox ? [[{ field: "_ck", checkbox: true }]] : undefined), columns: (opts.columns && opts.columns.length) ? opts.columns : [[{
                field: opts.textField, width: "100%", formatter: function (_b7f, row, _b80) {
                    return opts.textFormatter ? opts.textFormatter(_b7f, row, _b80) : _b7f;
                }
            }]]
        }));
    };
    var _b81 = $.extend({}, $.fn.datagrid.defaults.view, {
        render: function (_b82, _b83, _b84) {
    ...
    $.fn.datalist.defaults = $.extend({}, $.fn.datagrid.defaults, {
        fitColumns: true, singleSelect: true, showHeader: false, checkbox: false, lines: false, valueField: "value", textField: "text", groupField: "", view: _b81, textFormatter: function (_b9d, row) {
            return _b9d;
...
(function ($) {
    ...
    function _ba0(_ba1) {
        ...
        $(_ba1).addClass("combo-f").textbox($.extend({}, opts, {
            icons: _ba7, onChange: function () {
            }
        }));
    ...
    $.fn.combo.defaults = $.extend({}, $.fn.textbox.defaults, {
        inputEvents: { click: _bb2, keydown: _bb6, paste: _bb6, drop: _bb6, blur: _bb9 }, panelEvents: {
...
(function ($) {
    ...
    var _c3c = 0;
    var _c3d = {
        render: function (_c3e, _c3f, data) {
    ...
    $.fn.combobox.defaults = $.extend({}, $.fn.combo.defaults, {
        valueField: "value", textField: "text", groupPosition: "static", groupField: null, groupFormatter: function (_c43) {
            return _c43;
        }, mode: "local", method: "post", url: null, data: null, queryParams: {}, showItemIcon: false, limitToList: false, unselectedValues: [], mappingRows: [], view: _c3d, keyHandler: {
            up: function (e) {
                nav(this, "prev");
                e.preventDefault();
            }, down: function (e) {
            ...
            mouseover: _c21, mouseout: _c22, mousedown: function (e) {
                e.preventDefault();
                e.stopPropagation();
            }, click: _c23, scroll: _c26
            ...
            $.ajax({
                type: opts.method, url: opts.url, data: _c47, dataType: "json", success: function (data) {
                    _c48(data);
                }, error: function () {
...
(function ($) {
    function _c82(_c83) {
        ...
        var grid = _c84.grid;
        $(_c83).addClass("combogrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
...
(function ($) {
    function _cc7(_cc8) {
        ...
        $(_cc8).addClass("combotreegrid-f").combo($.extend({}, opts, {
            onShowPanel: function () {
        ...
        _cc9.grid.treegrid($.extend({}, opts, {
...
(function ($) {
    function _cf3(_cf4) {
        ...
        $(_cf4).addClass("tagbox-f").combobox($.extend({}, opts, {
            cls: "tagbox", reversed: true, onChange: function (_cf6, _cf7) {
                _cf8();
    ...
    $.fn.tagbox.defaults = $.extend({}, $.fn.combobox.defaults, {
        hasDownArrow: false, multiple: true, reversed: true, selectOnNavigation: false, tipOptions: $.extend({}, $.fn.textbox.defaults.tipOptions, { showDelay: 200 }), val: function (_d25) {
...
(function ($) {
    function _d2c(_d2d) {
        ...
        $(_d2d).addClass("datebox-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _d2f(this);
                _d30(this);
                _d31(this);
        ...
        if (!_d2e.calendar) {
            ...
            $.extend(_d2e.calendar.calendar("options"), {
...
(function ($) {
    function _d57(_d58) {
        ...
        $(_d58).datebox("calendar").calendar({
            onSelect: function (date) {
...
(function ($) {
    function _d7a(_d7b) {
        ...
        $(_d7b).addClass("timepicker-f").combo($.extend({}, opts, {
            onShowPanel: function () {
                _d7d(this);
                _d7e(_d7b);
...
(function ($) {
    ...
    function _dc6(_dc7) {
        ...
        _dc9.find("a.slider-handle").draggable({
    ...
    $.fn.slider.defaults = {
        width: "auto", height: "auto", mode: "h", reversed: false, showTip: false, disabled: false, range: false, value: 0, separator: ",", min: 0, max: 100, step: 1, rule: [], tipFormatter: function (_def) {
            return _def;
        }, converter: {
            toPosition: function (_df0, size) {
                var opts = $(this).slider("options");
